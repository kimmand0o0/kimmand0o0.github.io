...
[지난 편]({% post_url 2026-07/2026-07-22-k8s-study-01-why-k8s %})에서 K8s가 "선언 + reconcile 루프"로 상태를 유지한다는 걸 봤다. 그런데 그 루프가 실제로 관리하는 최소 단위가 뭔지 짚고 넘어가야 한다 — 놀랍게도 컨테이너가 아니라 **[Pod](https://kubernetes.io/docs/concepts/workloads/pods/)**다.
