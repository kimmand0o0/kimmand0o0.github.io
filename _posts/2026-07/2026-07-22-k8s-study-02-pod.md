...
[지난 편](/journal/development%20diary/2026/07/22/k8s-study-01-why-k8s.html)에서 K8s가 "선언 + reconcile 루프"로 상태를 유지한다는 걸 봤다. 그런데 그 루프가 실제로 관리하는 최소 단위가 뭔지 짚고 넘어가야 한다 — 놀랍게도 컨테이너가 아니라 **[Pod](https://kubernetes.io/docs/concepts/workloads/pods/)**다.
...
3. **저장공간 공유:** Pod에 [볼륨](https://kubernetes.io/docs/concepts/storage/volumes/)을 붙이면, 그 안의 모든 컨테이너가 같은 파일을 읽고 쓸 수 있음
