...
- **랭킹 전략 조립식 구조** — 평가 점수, 승률, Glicko-2 배치 레이팅 중 최대 3개를 모임마다 원하는 순서로 조합할 수 있게. 어떤 모임은 평가 없이 순수 배치 시스템만 쓰고 싶어할 수 있다는 가정을 코드가 아니라 설정으로 흡수한다. (자세한 건 [12편]({% post_url 2026-07/2026-07-22-lol-moim-incidents-12-ranking-pipeline-glicko %})에 남겨뒀다.)
