...
전체 경제 관점에서 이 방향이 맞았다는 건 나중에 숫자로도 확인했다. [대시보드 스냅샷](/journal/development%20diary/2026/07/16/lol-moim-incidents-06-dashboard-snapshot.html)에서 봤듯 주간 포인트 발행과 소비가 비슷한 수준에서 순환하고 있는데, 복권이 152% 시절 그대로였다면 이 균형은 진작 무너졌을 것이다.
